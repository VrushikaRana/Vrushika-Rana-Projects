    ...
    <div>
        ...
        <div class="form-control">
         ...
         <button onclick="generatePasswords()" class="generate" id="generate">Generate Passwords</button>
          ...
          <p><span style="color: red; font-size: 20px;"> Chose Any one password & Click on Copy Password Button  </span></p>
          <form action="encryption.php" method="post">
            <p><span style="color: red; font-size: 20px;">The generated password Encrypt Because of increase your password security Click on Encrypt Password Button</span></p>
